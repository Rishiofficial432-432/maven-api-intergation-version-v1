        ...
        <nav className="p-3 space-y-2 border-b border-border/50">
            ...
            >
             ...
             <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors ${isCollapsed ? 'justify-center' : 'justify-start'} ${view === 'notebook' ? 'bg-accent text-accent-foreground' : 'text-muted-foreground hover:bg-accent/50 hover:text-accent-foreground'}`}
                title="Notebook"
            >
                <BookCopy className="w-5 h-5 flex-shrink-0" />
            ...
            >
             ...
             <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors ${isCollapsed ? 'justify-center' : 'justify-start'} ${view === 'about' ? 'bg-accent text-accent-foreground' : 'text-muted-foreground hover:bg-accent/50 hover:text-accent-foreground'}`}
                title="About Maven"
            >
            ...
            <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors ${isCollapsed ? 'justify-center' : 'justify-start'} ${view === 'research' ? 'bg-accent text-accent-foreground' : 'text-muted-foreground hover:bg-accent/50 hover:text-accent-foreground'}`}
                title="Research"
            >
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        {view === 'notes' ? (
          ...
          <div className={`p-4 text-center text-muted-foreground text-sm flex flex-col items-center`}>
             ...
             {view === 'notebook' && <BookCopy className="w-8 h-8 mx-auto mb-2"/>}
